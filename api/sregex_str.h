...
typedef uint8_t sregex_str_td; // utf-8, NULL terminated.
...
size_t sregex_str_validate(sregex_str_td const * const borrowed_to_validate, size_t to_validate_len);
...
// return value is allocated using malloc and will be null iff allocation failed.
